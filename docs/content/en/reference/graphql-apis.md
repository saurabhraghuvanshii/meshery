...
<!---
  ...
  Please do not edit this file directly. Meshery's GraphQL schema is generated
  from the source schema definitions and exported alongside the OpenAPI bundles
  in the meshery/schemas repository (https://github.com/meshery/schemas).
--->
